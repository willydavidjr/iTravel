...
public class OwnTripMain extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.owntrip_main);
        ...
        final Button btnSuggest  = (Button) findViewById(R.id.btnSuggestMe);
        ...
        // setting image resource from drawable
        final Button btnOrganize  = (Button) findViewById(R.id.btnOrganize);
